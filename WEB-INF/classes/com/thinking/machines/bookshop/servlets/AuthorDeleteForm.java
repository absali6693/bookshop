...
public class AuthorDeleteForm extends HttpServlet
{
...
pw.println("<form action=/bookshop/AuthorDeleteConfirmationForm>");
...
pw.println("<input type='submit' value='Delete Author'><br/>");
